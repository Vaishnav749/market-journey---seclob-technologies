...
class Renewalpackageaddon extends StatefulWidget {
  const Renewalpackageaddon({super.key});

  @override
  State<Renewalpackageaddon> createState() => _RenewalpackageaddonState();
}

class _RenewalpackageaddonState extends State<Renewalpackageaddon> {
  var userid;
  List<dynamic> renewalPackageadd = [];
  XFile? _imageFile;
  ...
  Future<void> _viewpak() async {
    try {
      ...
      setState(() {
        renewalPackageadd = response['addOns'] ?? [];
      });
    } catch (error) {
            ...
            children: [
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemCount: renewalPackageadd.length,
                  itemBuilder: (BuildContext context, int index) {
                    var transaction = renewalPackageadd[index];
                    return Padding(
